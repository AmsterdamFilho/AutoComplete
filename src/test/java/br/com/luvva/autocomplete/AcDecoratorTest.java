...
import br.com.luvva.autocomplete.control.*;
import br.com.luvva.autocomplete.service.ListItemsCollector;
import br.com.luvva.autocomplete.view.JwTable;
...
public class AcDecoratorTest
{
    ...
    private JTextField mainTestTextField;
    ...
    private AcDecorator mainTestDecorator;
    ...
    private Container createTestContentPane ()
    {
        mainTestDecorator = new AcDecorator();

        mainTestTextField = new JTextField();

        LabeledPanel labeledPanel = new LabeledPanel();
        labeledPanel.setComponent(mainTestTextField, "");
        mainTestLabel = labeledPanel.getLabel();
        mainTestLabel.setForeground(Color.red);
        ...
        JRadioButton rbNoAc =
                new AcTestRadioButton("Test removing autocomplete decoration", null, noAcLabelUpdater);
    ...
    private class TestDialog extends JDialog
    {
        ...
        {
            setModal(true);
            setTitle("Auto complete test");
            Container contentPane = new SpacedPanel(createTestContentPane(), 5, 5);
    ...
    private class GridBagLayoutPanel extends JPanel
    {
        private GridBagConstraints constraints = createDefaultConstraints();

        private GridBagLayoutPanel ()
        {
