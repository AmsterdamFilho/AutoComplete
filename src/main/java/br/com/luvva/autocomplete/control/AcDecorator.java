package br.com.luvva.autocomplete.control;

import br.com.luvva.autocomplete.view.*;
...
public class AcDecorator implements KeyListener, PropertyChangeListener, FocusListener, AcListener
{
    ...
    private class AcSwingWorker extends SwingWorker<List<Object[]>, Void>
    {
        ...
        protected void done ()
        {
            ...
            if (results != null && textComponent != null && textComponent.isFocusOwner())
            {
                if (results.isEmpty())
                {
    ...
    private class AcButton extends JButton
    {
        private AcButton ()
        {
